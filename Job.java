...
public class Job {
	...
	/**
	 * Gets a master list of every single user signed up for this job.
	 * @return the list of users signed up for this job
	 */
	...
	/**
	 * Gets a list of volunteers signed up for light work for this job.
	 * @return the volunteers signed up for light work
	 */
	...
	/**
	 * Gets a list of volunteers signed up for medium work for this job.
	 * @return the volunteers signed up for medium work
	 */
	...
	/**
	 * Gets a list of volunteers signed up for heavy work for this job.
	 * @return the volunteers signed up for heavy work
	 */
